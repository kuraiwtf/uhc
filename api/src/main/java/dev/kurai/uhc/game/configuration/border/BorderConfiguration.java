...
import static dev.kurai.uhc.util.api.option.Option.rangedOption;
...
public final class BorderConfiguration {
  ...
  public static final Option<Integer> INITIAL_SIZE_OPTION =
      rangedOption(key("initial_size"), 300, 3000, 1250);
  public static final Option<Integer> FINAL_SIZE_OPTION =
      rangedOption(key("final_size"), 100, 500, 300);
